                ...
                filteredTeachers.map((teacher) => (
                  ...
                  >
                    ...
                    <div className="flex items-center justify-between mb-3">
                      {/* Profile Photo */}
                      <img
                        src={teacher.image || "https://i.pravatar.cc/100?img=12"} // fallback image
                        alt={teacher.teacherName}
                        className="w-14 h-14 rounded-full border-2 border-gray-200 object-cover mr-3"
                      />
                    ...
                    {/* Details */}
                    <p className="text-gray-700 text-sm mb-1">
                      <span className="font-medium text-gray-600">Subject:</span> {teacher.subject}
                    </p>
                    <p className="text-gray-600 text-sm truncate">
                      <span className="font-medium">Email:</span> {teacher.email}
                    </p>
                    ...
                    <div className="flex justify-end mt-4 gap-2">
                      <button
                        ...
                        className="px-3 py-1.5 bg-yellow-400/90 text-white text-xs rounded-lg shadow hover:bg-yellow-500 transition"
                      >
                        Edit
                      </button>
                      <button
                        ...
                        className="px-3 py-1.5 bg-red-600/90 text-white text-xs rounded-lg shadow hover:bg-red-700 transition"
                      >
                        Delete
                      </button>
                    </div>
